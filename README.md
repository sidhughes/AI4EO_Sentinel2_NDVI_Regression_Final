...
The diagram below illustrates the AI Regression models used in this project:
...
Because some `(B8 + B4)` values may be zero `1e-10` was added to avoid division by zero errors. This does not meaningfully change NDVI value. 
...
For video explaining the project workflow, code structure, model comparison and results:

[Click Here](https://youtu.be/ShXVctgQbxM)
